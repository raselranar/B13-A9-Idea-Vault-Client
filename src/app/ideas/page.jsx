    ...
    <section className="container mx-auto py-12">
      ...
      <section className="w-fit">
        <div className="text-gray-500">
          Showing <span className="font-bold">9</span> ideas
        </div>
        {/* cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto place-content-center w-fit px-4 mt-4">
          {allIdeas.map((idea) => (
